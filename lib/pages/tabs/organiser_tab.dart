          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: Colors.grey.withValues(alpha: isDark ? 0.05 : 0.08), blurRadius: 4)],
              ),
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  const Icon(Icons.flag, color: Colors.green, size: 22, semanticLabel: 'Objectifs du jour'),
            ...
            const SectionHeader(title: 'Productivité'),
            ToolCard(
              icon: Icons.timer_outlined, title: 'Pomodoro',
              subtitle: 'Sessions de travail concentré (${AppNumbers.pomodoroWorkMinutes}/${AppNumbers.pomodoroShortBreakMinutes} min)',
              color: Colors.red,
            ...
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                const Row(children: [
                  Icon(Icons.lightbulb, color: Colors.amber, size: 20, semanticLabel: 'Conseils'),
                  SizedBox(width: 8),
                  Text('Conseils d\'organisation', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                ]),
                const SizedBox(height: 12),
                ...AppStrings.conseilsOrganisation.map((c) => ConseilItem(text: c)),
              ]),
            ),
