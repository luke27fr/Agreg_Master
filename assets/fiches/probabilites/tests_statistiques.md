...
> * **Erreur de type I ($\alpha$) :** Rejeter $H_0$ alors qu'elle est vraie. $\alpha = \mathbb{P}(W | H_0)$.
> * **Erreur de type II ($\beta$) :** Accepter $H_0$ alors qu'elle est fausse. $\beta = \mathbb{P}(W^c | H_1)$.
